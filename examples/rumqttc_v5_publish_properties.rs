...
//!
//! ```sh
//! cargo run --features "rumqttc-v5,macros,json" --example rumqttc_v5_publish_properties
//! ```

use bytes::Bytes;
use mqtt_typed_client::{JsonSerializer, MqttClient};
use mqtt_typed_client_macros::mqtt_topic;
use rumqttc_v5::mqttbytes::v5::PublishProperties;
use rumqttc_v5::{PublishOptions, QoS};
